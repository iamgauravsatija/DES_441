 ...
 **/
    ...
    public class GUI_DES_javafx extends Application {
        ...
        // Objects for DES_encryption and DES_decryption class to call the respective methods.
        ...
        public void start(Stage primaryStage) throws Exception {
            ...
            window_main.setTitle("DES messenger");
...
/*
*** Ignore this part as the following code is for new tab feature which is
*** not being implemented for this version.


For now the new tab option is disabled as it was creating issues
but will be available in the later versions
            Tab temp_tabs[] = new Tab[number_of_tabs+1];
            Split_Pane_extended temp_pane_array[] = new Split_Pane_extended[number_of_tabs+1];
            new_tab.onActionProperty().setValue(new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
                    number_of_tabs++;

                    for(int i = 0; i < number_of_tabs; i++){
                        if(i < number_of_tabs - 2) {
                            temp_tabs[i] = tabs_array[i];
                            temp_pane_array[i] = tabs_pane_array[i];
                        }else if (i == number_of_tabs -1){
                            temp_tabs[i] = new Tab("Tab "+(i+1));
                            tabs_array = temp_tabs;
                            tabs_pane_array = temp_pane_array;
...
*/
            ...
            see_tutorial_video.onActionProperty().setValue(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    try {
                        URL url = new URL("https://drive.google.com/file/d/1L0AnzaM-dCns7A3BG07eLWilqogn1aon/view?usp=sharing");
...
/*
  Ignore this block comments. This is for future versions
                    JFrame dialog_box = new JFrame();
                       ...
                       JTextField temp_textField = new JTextField();
                        ...
                        dialog_box.add(jOptionPane,0);
                        jOptionPane.add(temp_textField);
                        dialog_box.setResizable(false);
                        dialog_box.setSize(400,200);
                        dialog_box.setVisible(true);


                    temp_frame = new JFrame();
                    GUI_DES_javafx temp_object = new GUI_DES_javafx();
                    ...
                    String string_input = "";
                    try {
                        string_input = temp_object.getDataInFile(file_location);
 ...
 */
    ...
    class Split_Pane_extended extends SplitPane {
         ...
         */
            public SplitPane getSplitPane() throws IOException {
                ...
                Label label_instruction = new Label("Enter secret key below with minimum \n8 characters for better security \n");

                //label_instruction.setWrapText(true);
                label_instruction.setFont(Font.font("Arial", FontWeight.NORMAL, 12));
    ...
    /**
     * The Open_FileChooser contains a function called openfilemethod() which was taking a lot
     * of time on my machine to open and execute while I was calling it from the App.
     * So I removed the function from the Application. But it can be useful in the future versions.
     *
     */
        static class Open_Filechooser{
        ...
        // Class to open the video in web browser
